...
//initialisation pour le calcul du checksum
 uint8_t flag = 0;
...
uint32_t mypressure, mytemperature;
HMC_t module;
...
//	MPU_ConfigTypeDef myMPUConfig;
  ...
  /* à décocher si utilisation du filtre passe-bas
  // Initialisation de la MPU6050
  MPU6050_Init(&hi2c1);
  //Configuration de la MPU6050
  myMPUConfig.Accel_Full_Scale = AFS_SEL_4g;
  myMPUConfig.CONFIG_DLPF = Internal_8MHz;
  myMPUConfig.ClockSource = DLPF_184A_188G_Hz;
  myMPUConfig.Gyro_Full_Scale = FS_SEL_500;
  myMPUConfig.Sleep_Mode_Bit = 0;  // Mettre à 1 signifie que la MPU est en sleep mode, 0 => mode normal


  MPU6050_Config(&myMPUConfig);
 */

  //initialisation de l'accéléro/gyro
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  /* à décocher si filtre passe-bas est utilisé
